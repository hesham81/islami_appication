...
import '../widgets/sure_recenet.dart';
...
class _QuranState extends State<Quran> {
  ...
  final List<SuraModel> suras = [
    ...
    SuraModel(id: 4, nameAr: "النساء", nameEn: "An-Nisa", versesNumber: "176"),
    SuraModel(
    ...
    SuraModel(id: 8, nameAr: "الأنفال", nameEn: "Al-Anfal", versesNumber: "75"),
    SuraModel(
    ...
    SuraModel(id: 14, nameAr: "إبراهيم", nameEn: "Ibrahim", versesNumber: "52"),
    SuraModel(id: 15, nameAr: "الحجر", nameEn: "Al-Hijr", versesNumber: "99"),
    SuraModel(id: 16, nameAr: "النحل", nameEn: "An-Nahl", versesNumber: "128"),
    SuraModel(
        id: 17, nameAr: "الإسراء", nameEn: "Al-Isra", versesNumber: "111"),
    SuraModel(id: 18, nameAr: "الكهف", nameEn: "Al-Kahf", versesNumber: "110"),
    ...
    SuraModel(
        id: 23, nameAr: "المؤمنون", nameEn: "Al-Mu'minun", versesNumber: "118"),
    SuraModel(id: 24, nameAr: "النور", nameEn: "An-Nur", versesNumber: "64"),
    SuraModel(
        id: 25, nameAr: "الفرقان", nameEn: "Al-Furqan", versesNumber: "77"),
    SuraModel(
        id: 26, nameAr: "الشعراء", nameEn: "Ash-Shu'ara", versesNumber: "227"),
    SuraModel(id: 27, nameAr: "النمل", nameEn: "An-Naml", versesNumber: "55"),
    SuraModel(id: 28, nameAr: "القصص", nameEn: "Al-Qasas", versesNumber: "88"),
    SuraModel(
    ...
    SuraModel(id: 32, nameAr: "السجدة", nameEn: "As-Sajda", versesNumber: "30"),
    SuraModel(
    ...
    SuraModel(id: 39, nameAr: "الزمر", nameEn: "Az-Zumar", versesNumber: "75"),
    ...
    SuraModel(
        id: 51, nameAr: "الذاريات", nameEn: "Adh-Dhariyat", versesNumber: "60"),
    SuraModel(id: 52, nameAr: "الطور", nameEn: "At-Tur", versesNumber: "49"),
    SuraModel(id: 53, nameAr: "النجم", nameEn: "An-Najm", versesNumber: "62"),
    SuraModel(id: 54, nameAr: "القمر", nameEn: "Al-Qamar", versesNumber: "55"),
    SuraModel(
        id: 55, nameAr: "الرحمن", nameEn: "Ar-Rahman", versesNumber: "78"),
    SuraModel(
        id: 56, nameAr: "الواقعة", nameEn: "Al-Waqi'a", versesNumber: "96"),
    SuraModel(id: 57, nameAr: "الحديد", nameEn: "Al-Hadid", versesNumber: "29"),
    SuraModel(
        id: 58, nameAr: "المجادلة", nameEn: "Al-Mujadila", versesNumber: "22"),
    SuraModel(id: 59, nameAr: "الحشر", nameEn: "Al-Hashr", versesNumber: "24"),
    SuraModel(
        id: 60, nameAr: "الممتحنة", nameEn: "Al-Mumtahina", versesNumber: "13"),
    ...
    SuraModel(id: 65, nameAr: "الطلاق", nameEn: "At-Talaq", versesNumber: "12"),
    SuraModel(
        id: 66, nameAr: "التحريم", nameEn: "At-Tahrim", versesNumber: "12"),
    SuraModel(id: 67, nameAr: "الملك", nameEn: "Al-Mulk", versesNumber: "30"),
    SuraModel(id: 68, nameAr: "القلم", nameEn: "Al-Qalam", versesNumber: "52"),
    SuraModel(
    ...
    SuraModel(
        id: 77, nameAr: "المرسلات", nameEn: "Al-Mursalat", versesNumber: "50"),
    ...
    SuraModel(
        ...
        versesNumber: "36"),
    SuraModel(
        id: 84, nameAr: "الإنشقاق", nameEn: "Al-Inshiqaq", versesNumber: "25"),
    SuraModel(id: 85, nameAr: "البروج", nameEn: "Al-Buruj", versesNumber: "22"),
    SuraModel(id: 86, nameAr: "الطارق", nameEn: "At-Tariq", versesNumber: "17"),
    SuraModel(id: 87, nameAr: "الأعلى", nameEn: "Al-A'la", versesNumber: "19"),
    SuraModel(
        id: 88, nameAr: "الغاشية", nameEn: "Al-Ghashiyah", versesNumber: "26"),
    SuraModel(id: 89, nameAr: "الفجر", nameEn: "Al-Fajr", versesNumber: "30"),
    SuraModel(id: 90, nameAr: "البلد", nameEn: "Al-Balad", versesNumber: "20"),
    SuraModel(id: 91, nameAr: "الشمس", nameEn: "Ash-Shams", versesNumber: "15"),
    SuraModel(id: 92, nameAr: "الليل", nameEn: "Al-Layl", versesNumber: "21"),
    SuraModel(id: 93, nameAr: "الضحى", nameEn: "Adh-Dhuha", versesNumber: "11"),
    SuraModel(id: 94, nameAr: "الشرح", nameEn: "Ash-Sharh", versesNumber: "8"),
    ...
    SuraModel(id: 111, nameAr: "المسد", nameEn: "Al-Masad", versesNumber: "5"),
    SuraModel(
        id: 112, nameAr: "الإخلاص", nameEn: "Al-Ikhlas", versesNumber: "4"),
    SuraModel(id: 113, nameAr: "الفلق", nameEn: "Al-Falaq", versesNumber: "5"),
    SuraModel(id: 114, nameAr: "الناس", nameEn: "An-Nas", versesNumber: "6"),
  ];
  String searchQuery = "";
  List<SuraModel> searchSuraModel = [];
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(AppAssets.writtenIslami),
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  fillColor: AppColors.secondaryColor.withAlpha(170),
                  filled: true,
              ...
              Visibility(
                ...
                replacement: ListView.separated(
                  ...
                  itemBuilder: (context, index) => SuraNumberWidget(
                    model: searchSuraModel[index],
                  ),
